...
namespace ae_ecs {
    ...
    void AeSystemBase::registerDependency(ecs_id t_predecessorSystemId){
    ...
    ecs_systemInterval AeSystemBase::getSystemInterval() const {return m_systemInterval; };

    // Specify the frequency in which the system runs, for instance an object clean-up system may not run every frame
    void AeSystemBase::setSystemInterval(ecs_systemInterval t_systemInterval){
